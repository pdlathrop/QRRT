...
D = 2; %dimension, only coded for D = 2;
...
tic
[nodes_q,parents_q,oraclecount_q] = QRRT(grid,x_init,x_goal,2,r);
t_elapsed_q = toc

tic
[nodes_c,parents_c,oraclecount_c] = RRTclassical(grid,x_init,x_goal,2);
t_elapsed_c = toc

plotfinaltree(grid,nodes_q,parents_q)
plotfinaltree(grid,nodes_c,parents_c)
